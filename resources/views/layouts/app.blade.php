        ...
        <div class="footer wow fadeIn" data-wow-delay="0.3s">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-3">
                        <div class="footer-contact">
                            ...
                            @endguest
                            <p><i class="fa fa-map-marker-alt"></i>{{$set->address}}</p>
                            <p><i class="fa fa-phone-alt"></i>{{$set->hotline}}</p>
                            <p><i class="fa fa-envelope"></i>{{$set->email}}</p>
            ...
            <div class="container copyright">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <p>Designed By <a href="https://htmlcodex.com">DUONGHV</a></p>
                    </div>
                </div>
            </div>
        </div>
